            ...
            <nav class="navbar navbar-expand-lg navbar-dark">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav">
                        ...
                        &nbsp;
                        <li class="nav-item mt-3 mt-lg-1 p-1">
                            <a class="nav-link active" href="completedquiz.php" style="color:white;"><i class="fa-solid fa-square-check"></i>&nbsp;Completed</a>
                        </li>
                        &nbsp;
                        <li class="nav-item mt-3 mt-lg-1 p-1" style="background-color:black;border-radius:100px">
                            <a class="nav-link active" href="incompletedquiz.php" style="color:white;font-weight:500"><i class="fa-solid fa-house"></i>&nbsp;Incompleted</a>
                        </li>
                        &nbsp;
