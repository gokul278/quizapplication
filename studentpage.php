            ...
            <nav class="navbar navbar-expand-lg navbar-dark">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <a class="nav-link active" href="studentpage.php" style="color:white;font-weight:500"><i class="fa-solid fa-house"></i>&nbsp;Home&nbsp;</a>
                        </li>
                        &nbsp;
            ...
            <div class="cards pt-5">
               ...
               foreach($res as $value){
                echo '<div class="card">
                        ...
                        <input class="attend" type="hidden" value="'.$value[$_SESSION["userid"]].'">
                    </div>';
               }
               ?>
            </div>
